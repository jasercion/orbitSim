 ...
 * @brief This file contains all structures definition used by the orbit
 * Simulator.
 * @author Giuseppe Romeo
 * @date Created:  Nov 15, 2005
 *
 * $Header:
 * /nfs/slac/g/glast/ground/cvs/ScienceTools-scons/orbitSim/orbitSim/orbitSimStruct.h,v
 * 1.3 2009/05/06 15:25:37 vernaleo Exp $
 */
...
typedef struct
{
  ...
  /// SAA file definition
  std::string saafile;
  /// Flag which is used to decide if Earth avoidance should be enabled, default
  /// is yes.
  int occflag;
...
typedef struct
{
  /// this is the ROCKSTART in mjd, or when the profile survey cycle is sopposed
  /// to begin
  double epoch;
